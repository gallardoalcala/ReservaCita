...
public class CitaWrapper implements Cita, ModelWrapper<Cita> {
    ...
    */
    ...
    @Override
    public int compareTo(com.proyecto.clientes.model.Cita cita) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.proyecto.clientes.model.Cita> toCacheModel() {
        return _cita.toCacheModel();
    }

    @Override
    public com.proyecto.clientes.model.Cita toEscapedModel() {
        return new CitaWrapper(_cita.toEscapedModel());
    }

    @Override
    public com.proyecto.clientes.model.Cita toUnescapedModel() {
