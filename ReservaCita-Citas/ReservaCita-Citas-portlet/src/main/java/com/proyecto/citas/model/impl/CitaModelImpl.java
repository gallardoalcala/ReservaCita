...
import com.proyecto.citas.model.CitaModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.proyecto.citas.model.CitaModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CitaImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see CitaImpl
 * @see com.proyecto.citas.model.Cita
 * @see com.proyecto.citas.model.CitaModel
 * @generated
 */
public class CitaModelImpl extends BaseModelImpl<Cita> implements CitaModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a cita model instance should use the {@link com.proyecto.citas.model.Cita} interface instead.
     */
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.proyecto.citas.model.Cita"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.proyecto.citas.model.Cita"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.proyecto.citas.model.Cita"),
            true);
    public static long IDCITA_COLUMN_BITMASK = 1L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.com.proyecto.citas.model.Cita"));
    ...
    private int _idCita;
    private int _originalIdCita;
    private boolean _setOriginalIdCita;
    ...
    public void setIdCita(int idCita) {
        _columnBitmask |= IDCITA_COLUMN_BITMASK;

        if (!_setOriginalIdCita) {
            _setOriginalIdCita = true;

            _originalIdCita = _idCita;
        }

        _idCita = idCita;
    }

    public int getOriginalIdCita() {
        return _originalIdCita;
    }
    ...
    public void resetOriginalValues() {
        ...
        citaModelImpl._originalIdCita = citaModelImpl._idCita;

        citaModelImpl._setOriginalIdCita = false;
