...
/**
 * The persistence utility for the horario trabajo service. This utility wraps {@link HorarioTrabajoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class HorarioTrabajoUtil {
    private static HorarioTrabajoPersistence _persistence;
     ...
     */
    public static void clearCache(HorarioTrabajo horarioTrabajo) {
        getPersistence().clearCache(horarioTrabajo);
    }
     ...
     */
    public static List<HorarioTrabajo> findWithDynamicQuery(
     ...
     */
    public static HorarioTrabajo update(HorarioTrabajo horarioTrabajo)
        throws SystemException {
        return getPersistence().update(horarioTrabajo);
    }
    ...
    public static HorarioTrabajo update(HorarioTrabajo horarioTrabajo,
        ...
        return getPersistence().update(horarioTrabajo, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(horarioTrabajo);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(horarioTrabajos);
    }
    ...
    */
    public static com.proyecto.citas.model.HorarioTrabajo create(int idHorario) {
        return getPersistence().create(idHorario);
    }
    ...
    */
    public static com.proyecto.citas.model.HorarioTrabajo remove(int idHorario)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.proyecto.citas.NoSuchHorarioTrabajoException {
        return getPersistence().remove(idHorario);
    }

    public static com.proyecto.citas.model.HorarioTrabajo updateImpl(
        com.proyecto.citas.model.HorarioTrabajo horarioTrabajo)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(horarioTrabajo);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.proyecto.citas.model.HorarioTrabajo findByPrimaryKey(
        int idHorario)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.proyecto.citas.NoSuchHorarioTrabajoException {
        return getPersistence().findByPrimaryKey(idHorario);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.proyecto.citas.model.HorarioTrabajo fetchByPrimaryKey(
        int idHorario)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().fetchByPrimaryKey(idHorario);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.proyecto.citas.model.HorarioTrabajo> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static HorarioTrabajoPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (HorarioTrabajoPersistence) PortletBeanLocatorUtil.locate(com.proyecto.citas.service.ClpSerializer.getServletContextName(),
                    HorarioTrabajoPersistence.class.getName());

            ReferenceRegistry.registerReference(HorarioTrabajoUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(HorarioTrabajoPersistence persistence) {
    }
}
