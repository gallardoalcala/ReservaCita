...
/**
 * Provides the local service interface for Cita. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CitaLocalServiceUtil
...
public interface CitaLocalService extends BaseLocalService, InvokableLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CitaLocalServiceUtil} to access the cita local service. Add custom service methods to {@link com.proyecto.citas.service.impl.CitaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
